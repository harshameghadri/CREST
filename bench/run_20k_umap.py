...
plt.scatter(valid_umap[:, 0], valid_umap[:, 1], s=0.5, alpha=0.5, c='darkblue', edgecolors='none')
plt.title("BioPolars: Native Rust SVD + UMAP on 20k Neurons", fontsize=16, fontweight='bold')
plt.axis('off')
